...
### GAS Hierarchy - Number of minutes per class engaged in online Spanish lecture (60 minute class)
...
```{r, include=FALSE, fig.height=8, fig.width=10}
brief_parent_plot
```
...
```{r, include=FALSE, fig.height=8, fig.width=11}
class_self_2_plot
```
...
status_plot_all <- ggplot(status_all, aes(session, status)) +
  ...
  labs(x = "Session",
       ...
       caption = "60-minute lecture, 5 days per week") 
